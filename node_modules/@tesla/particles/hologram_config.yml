...
documentation_assets: ./styleguide_assets
...
code_example_templates: ./styleguide_assets/code_example_templates
...
code_example_renderers: ./styleguide_assets/code_example_renderers

# Any other asset folders that need to be copied to the destination
# folder. Typically this will include the css that you are trying to
# document. May also include additional folders as needed.
#dependencies:
#  - ./doc_assets/from-d7/styles.css
