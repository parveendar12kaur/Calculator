...
$locale_us:                  i18n-en;    // US TODO: deprecate this in favor of the fully qualified locale + language
$locale-us_english:          i18n-en_US; // US

// Europe
$locale-belgium_french:      i18n-fr_BE; // fr_BE
$locale-belgium_dutch:       i18n-nl_BE; // nl_BE
$locale-denmark:             i18n-da;    // da_DK TODO: deprecate this in favor of the fully qualified locale + language
$locale-denmark_danish:      i18n-da_DK; // da_DK
$locale-germany:             i18n-de;    // de_DE TODO: deprecate this in favor of the fully qualified locale + language
$locale-germany_german:      i18n-de_DE; // de_DE
$locale-france:              i18n-fr;    // fr_FR TODO: deprecate this in favor of the fully qualified locale + language
$locale-france_french:       i18n-fr_FR; // fr_FR
$locale-great_britain:       i18n-en_GB; // en_GB
$locale-italy:               i18n-it;    // it_IT TODO: deprecate this in favor of the fully qualified locale + language
$locale-italy_italian:       i18n-it_IT; // it_IT
$locale-ireland:             i18n-en_IE; // en_IE
$locale-netherlands:         i18n-nl;    // nl_NL TODO: deprecate this in favor of the fully qualified locale + language
$locale-netherlands_dutch:   i18n-nl_NL; // nl_NL
$locale-norway:              i18n-no;    // no_NO TODO: deprecate this in favor of the fully qualified locale + language
