...
// _particles/documentation/_tsla-header.documentation.scss
// ------------------------------------------------------------
...
.tsla-header {
  ...
  &-nav {
    ...
    @include susy-breakpoint($mobile-only) {
      ...
      &::before {
        width: 100%;
        height: map-get($menu-map, header-height) - $gutter;
        display: block;
        position: sticky;
        top: 0;
        left: 0;
  ...
  &-nav--list {
    ...
    @include susy-breakpoint($mobile-only) {
      ...
      .tsla-header-nav--list {
        &.tsla-header-nav--primary_right {
          display: block;
          margin: 0;
          padding: 0;
        }

        .tsla-header-nav--auth_link {
          display: none;
        }
      }
    }
...
[id='tsla-header-main--trigger']:checked {
  ...
  ~ [id='tsla-header-mask'] {
    ...
    .tsla-header-alternate_mobile & {
      @include susy-breakpoint($mobile-only) { top: map-get($menu-map, header-height); }
    }
  }
}
...
.tsla-header-main--trigger_icon {
  ...
  &::after {
    ...
    .tsla-header-alternate_mobile & {
      @include susy-breakpoint($mobile-only) { background-color: map-get($header-colors, header_default); }
    }
    ...
    .tsla-header-transparent--light & {
      @include susy-breakpoint($small-desktop) { background-color: map-get($header-colors, header_alternate); }
    }
...
.tsla-header-main--cross_hatch {
  ...
  .tsla-header-transparent--dark & {
    @include susy-breakpoint($small-desktop) { background-color: map-get($header-colors, header_default); }
  }
...
[id='tsla-header-main--trigger']:checked {
  ...
  ~ [for='tsla-header-main--trigger'] {
    ...
    .tsla-header-main--cross_hatch {
      ...
      .tsla-header-semitransparent & {
        @include susy-breakpoint($mobile-only) { background-color: map-get($header-colors, header_transparent); }
      }
...
// Hide the My Account link by default so we can wait for
// JavaScript to no longer be blocked by slow-running scripts
.tsla-link_for-logout {
  @include susy-breakpoint($small-desktop) {
    opacity: 0;
    z-index: -1;
