...
// DESCRIPTION: Collection of all the variables necessary for building the
// website.
//
// 1. Global Compass/Sass variables
// 2. i18n variables
// 3. Color variables
// 4. Typographic Variables
// 5. Grid- and Column-based variables
...
// --- 1. Global Compass/Sass
// ------------------------------------------------------------------------
$default-images-path: '/sites/default/files/';

// 2. i18n
@import 'variables-locales';
...
$image-path-for-code: '/assets/img/' !default;
...
// Gotham Variables
$gotham-extra-light: 'Gotham Extra Light'; // font-weight: 200;
$gotham-light:       'Gotham Light';       // font-weight: 300;
$gotham-book:        'Gotham Book';        // font-weight: 400;
$gotham-medium:      'Gotham Medium';      // font-weight: 500;
$gotham-bold:        'Gotham Bold';        // font-weight: 700;
...
// --- Grid Setup
$column-width: $tsla-size--xlarge;
$grid-padding: $tsla-size--xsmall;
...
// --- 6. Media Query
// ------------------------------------------------------------------------
// 640px             and below is mobile
// 640px - 960px     there's a horizontal scroll
// 960px-1080px      it scales
// 1080px+           the page is centered
// ------------------------------------------------------------------------
$gutter: $tsla-size--small;
...
$susy: (
  ...
  container: 1400px,
  column-width: $tsla-size--xxlarge,
...
// for targeting lower than 639 px
// Example of included devices: HTC One (640px), Galaxy S3, S4, S5 (640px), iPhone 5,
// 5S (568px), iPhone 4 (480px)
$mobile-only: 0 639px !default;

// for targeting between 640-960 px
$small-desktop-only: 640px 960px !default;

// for targeting greater than 640 px
$small-desktop: 640px !default;

// for targeting greater than 960 px
$large-desktop: 960px !default;

// -- Additional Media Queries to include more devices
// Example of included devices: HTC One (639px), Galaxy S3, S4, S5 (639px), iPhone 5,
// 5S (568px), iPhone 4 (480px)iPhone 6 (667px), iPhone 6+ (736px)
$mobile-phone-only: 0 736px !default;

// for targeting common tablet-sized devices
// Example of included devices: iPad (768px - 1024px), Galaxy (800px - 1280px),
// Nexus (601px - 906px), Kindle (800px - 1280px)
$tablet-only: 601px 1280px !default;

// for targeting devices 1200px+ wide
$large-devices: 1200px !default;
