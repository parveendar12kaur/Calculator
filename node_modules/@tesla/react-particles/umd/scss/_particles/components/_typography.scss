...
@import 'typography.documentation';
...
@include exports('typography') {
  ...
  a {
    ...
    &:hover {
      ...
      // @TODO: this needs to be moved back to Drupal
      [id='system_messages'] & {
        color: $tesla-primary;
      }
    }
  ...
  .sub-header,
  .section-header {
    @include fontstack-primary('Gotham Light');
  }
  ...
  // @TODO: this needs to be moved to Drupal
  .basic-format-text {
    font-size: 14px;
